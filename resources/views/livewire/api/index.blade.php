<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card dashboard-product">
            <h4>Get All sms By Phone Number</h4>
            <p>{!! url('/') !!}/api/messages/{phone}</p>
        </div>
    </div>
    <div class="col-lg-12">
        <div class="card dashboard-product">
            <h4>Response</h4>
            <pre id="AllByPhone"></pre>
        </div>
    </div>
    ...
    <div class="col-lg-12">
        <div class="card dashboard-product">
            <h4>Get All sms By Phone Number</h4>
            <p>{!! url('/') !!}/api/message/get/latest/{phone}</p>
        </div>
    </div>
    <div class="col-lg-12">
        <div class="card dashboard-product">
            <h4>Response</h4>
            <pre id="AllSMSByPhone"></pre>
        </div>
    </div>
    ...
    <div class="col-lg-12">
        <div class="card dashboard-product">
            <h4>Get Last sms By Phone Number</h4>
            <p>{!! url('/') !!}/api/message/get/latest/{phone}</p>
        </div>
    </div>
    <div class="col-lg-12">
...
<script>
        ...
        "data": [
            {
                "id": 16,
                "phone": "+8801930447025",
                "message": "000005 is your one time password for verification",
                "timestamp": "2024-10-01 13:20:43",
                "is_read": "1",
                "created_at": "2024-10-01T16:58:35.000000Z",
                "updated_at": "2024-10-01T17:20:43.000000Z"
            }
        ]
    }

 document.getElementById("AllSMSByPhone").textContent = JSON.stringify(AllSMSByPhone, undefined, 2);
 ...
 document.getElementById("LastByPhone").textContent = JSON.stringify(LastByPhone, undefined, 2);
